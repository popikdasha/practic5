...
namespace practic5 {
    ...
    public partial class ShopDbDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, decimal Price, CategoriesRow parentCategoriesRowByFK_Products_Categories) {
...
namespace practic5.ShopDbDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::practic5.Properties.Settings.Default.ShopDbConnectionString;
        }
        ...
        public virtual int Fill(ShopDbDataSet.CategoriesDataTable dataTable) {
        ...
        public virtual ShopDbDataSet.CategoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ShopDbDataSet.CategoriesDataTable dataTable = new ShopDbDataSet.CategoriesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ShopDbDataSet.CategoriesDataTable dataTable) {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ([Pro" +
                "ductName] = @Original_ProductName) AND ([Price] = @Original_Price) AND ([Categor" +
                "yId] = @Original_CategoryId))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductName], [Price], [CategoryId]) VALUES (@Prod" +
                "uctName, @Price, @CategoryId);\r\nSELECT ProductId, ProductName, Price, CategoryId" +
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [Price] = @Price, [CategoryId] = @CategoryId WHERE (([ProductId] = @Original_ProductId) AND ([ProductName] = @Original_ProductName) AND ([Price] = @Original_Price) AND ([CategoryId] = @Original_CategoryId));
SELECT ProductId, ProductName, Price, CategoryId FROM Products WHERE (ProductId = @ProductId)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductName, Price, CategoryId FROM dbo.Products";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ProductId, string Original_ProductName, decimal Original_Price, int Original_CategoryId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string ProductName, decimal Price, int CategoryId) {
            if ((ProductName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, decimal Price, int CategoryId, int Original_ProductId, string Original_ProductName, decimal Original_Price, int Original_CategoryId, int ProductId) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, decimal Price, int CategoryId, int Original_ProductId, string Original_ProductName, decimal Original_Price, int Original_CategoryId) {
